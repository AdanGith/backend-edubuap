    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.IntegerField(choices=[(0, 'Alumno'), (1, 'Profesor'), (2, 'Administrador')], default=0)),
                ...
                ('id_docente', models.CharField(blank=True, max_length=20, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fotografia_url', models.ImageField(blank=True, null=True, upload_to='perfiles/')),
                ('ultima_conexion_at', models.DateTimeField(blank=True, null=True)),
